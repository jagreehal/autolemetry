# Contributing to Autolemetry

Thank you for your interest in contributing to Autolemetry! This guide will help you get started.
...
1. **Fork and clone the repository:**
   ```bash
   git clone https://github.com/YOUR_USERNAME/autolemetry.git
   cd autolemetry
   ```
...
- **Questions?** Open a [Discussion](https://github.com/jagreehal/autolemetry/discussions)
- **Found a bug?** Open an [Issue](https://github.com/jagreehal/autolemetry/issues)
...
By contributing to Autolemetry, you agree that your contributions will be licensed under the MIT License.

---
'autolemetry-mcp': minor
'autolemetry-web': minor
---

Add autolemetry-mcp package for Model Context Protocol (MCP) instrumentation and privacy controls for autolemetry-web

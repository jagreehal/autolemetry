/**
 * Datadog preset for autolemetry
 *
...
/**
 * Create an autolemetry configuration optimized for Datadog.
 *
 * This preset handles:
 ...
 * @returns AutolemetryConfig ready to pass to init()
 *
...
export function createDatadogConfig(
  ...
  const baseConfig: AutolemetryConfig = {
    service,
    environment,
    version,
  };
  ...
  const cloudConfig: AutolemetryConfig = {
    ...baseConfig,

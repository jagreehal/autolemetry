 ...
 * ```typescript
 * import { traceLLM } from 'autolemetry/semantic-helpers'
 ...
 * ```typescript
 * import { traceDB } from 'autolemetry/semantic-helpers'
 * import { pool } from './db'
 *
 ...
 * @example Fetch API
 * ```typescript
 * import { traceHTTP } from 'autolemetry/semantic-helpers'
 *
 ...
 * ```typescript
 * import { traceMessaging } from 'autolemetry/semantic-helpers'

 ...
 *
 * These processors are already included in autolemetry's dependencies, so re-exporting
 ...
 * import { BatchSpanProcessor } from 'autolemetry/processors'
 *

 ...
 *
 * These exporters are already included in autolemetry's dependencies, so re-exporting
 ...
 * ```
 *
 * Note: For high-level testing utilities with assertion helpers, see `autolemetry/testing`.
 * For custom span processing, see `autolemetry/processors`.
 *
 * @module autolemetry/exporters

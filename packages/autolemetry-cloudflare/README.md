...
[![npm version](https://badge.fury.io/js/autolemetry-cloudflare.svg)](https://www.npmjs.com/package/autolemetry-cloudflare)
[![Bundle Size](https://img.shields.io/bundlephobia/minzip/autolemetry-cloudflare)](https://bundlephobia.com/package/autolemetry-cloudflare)
...
```bash
npm install autolemetry-cloudflare
# or
pnpm add autolemetry-cloudflare
# or
yarn add autolemetry-cloudflare
```
...
head_sampling_rate = 1.0      # Let autolemetry handle sampling
```
...
```typescript
import { wrapModule } from 'autolemetry-cloudflare'
...
```typescript
import { instrument } from 'autolemetry-cloudflare'
...
```typescript
import { trace, span } from 'autolemetry-cloudflare'
...
```typescript
import { createCustomTailSampler } from 'autolemetry-cloudflare/sampling'
...
```typescript
import { wrapDurableObject } from 'autolemetry-cloudflare'
...
```typescript
import { wrapModule, SamplingPresets } from 'autolemetry-cloudflare'
...
- [autolemetry-edge](../autolemetry-edge) - Vendor-agnostic foundation

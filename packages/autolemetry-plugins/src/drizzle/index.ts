...
const INSTRUMENTED_FLAG = '__autolemetryDrizzleInstrumented' as const;
...
export interface InstrumentDrizzleConfig {
  /**
   * Custom tracer name. Defaults to "autolemetry-plugins/drizzle".
   */
  tracerName?: string;
 ...
 * import { Pool } from 'pg';
 * import { instrumentDrizzle } from 'autolemetry-plugins/drizzle';
 *

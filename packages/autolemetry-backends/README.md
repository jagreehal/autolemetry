...
Vendor backend configurations for [Autolemetry](../autolemetry) - simplified setup helpers for popular observability platforms.
...
| ------------------------ | ----------------------------------------------------- | --------------------------- |
| **autolemetry-backends** | Configure **where** telemetry goes (outputs)          | Honeycomb, Datadog, Grafana |
| **autolemetry-plugins**  | Instrument **libraries** to create telemetry (inputs) | Drizzle ORM, custom SDKs    |
...
Want to add a new backend configuration? Please [open an issue](https://github.com/jagreehal/autolemetry/issues) to discuss.

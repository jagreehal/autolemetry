# Mongoose + Autolemetry Example

This example demonstrates how to use the **custom autolemetry-plugins/mongoose** package for complete MongoDB observability with automatic hook tracing.
...
```json
{
  ...
  "kind": "CLIENT",
  "instrumentationScope": { "name": "autolemetry-plugins/mongoose" },
  "attributes": {
    "db.system": "mongoose",
    "db.operation": "create",
...
instrumentMongoose(mongoose, {
  ...
  // Custom tracer name (default: 'autolemetry-plugins/mongoose')
...
- [autolemetry-plugins documentation](../../packages/autolemetry-plugins/README.md)
- [autolemetry core documentation](../../packages/autolemetry/README.md)

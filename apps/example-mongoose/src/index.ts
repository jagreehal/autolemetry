 ...
 *
 * This example demonstrates how to use autolemetry with Mongoose 8+ using the
 * custom autolemetry-plugins/mongoose implementation (runtime patching).
 *
 * Key features:
...
import { init, trace, shutdown } from 'autolemetry';
...
// Connect to MongoDB
const mongoUrl = process.env.MONGO_URL || 'mongodb://localhost:27017/autolemetry-example';

// Example: Create a user with autolemetry tracing
...
// Run the example
async function main() {
  console.log('\n🚀 Starting Mongoose + Autolemetry Example\n');

 ...
 *
 * This example demonstrates the recommended approach: using @openai/agents with autolemetry + OpenLLMetry.
 *
 * Architecture:
 ...
 * - autolemetry trace(): Wraps the workflow for correlation and business metrics
 *
 * Expected Spans (verified):
 * ✅ workflow.multi_agent_escalation - Root span from autolemetry trace()
...
// Initialize autolemetry with built-in OpenLLMetry support
...
// ======================
// Workflow Orchestration with autolemetry
// ======================

/**
 * Run Multi-Agent Workflow
 *
 * This wraps the @openai/agents execution with autolemetry's trace() to:

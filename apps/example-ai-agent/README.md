...
The **recommended approach** showing OpenLLMetry + autolemetry + @openai/agents integration:
...
- **autolemetry trace()**: Manual instrumentation for workflow orchestration and business metrics
...
3. **autolemetry trace()** for workflow orchestration (business context)

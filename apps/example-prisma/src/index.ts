/**
 * Prisma + Autolemetry Example
 *
 * This example demonstrates how to use autolemetry with Prisma ORM.
 *
 * Key features:
...
import { init, trace, type TraceContext } from 'autolemetry';
import { PrismaInstrumentation } from '@prisma/instrumentation';
import { PrismaClient } from '@prisma/client';

// Initialize autolemetry with PrismaInstrumentation
init({
...
// Main function
async function main() {
  console.log('🚀 Starting Prisma + Autolemetry example...\n');

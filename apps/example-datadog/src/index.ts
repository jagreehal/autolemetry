 ...
 *
 * This example demonstrates how to use autolemetry with Datadog using OTLP.
...
// ============================================================================
// Initialize Autolemetry with Datadog OTLP
// ============================================================================
...
// Initialize autolemetry with Datadog OTLP cloud ingestion
...
logger.info('✅ Autolemetry initialized with Datadog OTLP');
logger.info(

...
Example MCP client with automatic OpenTelemetry instrumentation using `autolemetry-mcp`. Demonstrates distributed tracing across MCP client-server boundaries.

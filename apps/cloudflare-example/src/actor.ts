/**
 * Cloudflare Actors example with autolemetry-cloudflare instrumentation
 *
 * This example demonstrates how to use @cloudflare/actors with autolemetry-cloudflare
...
import { tracedHandler } from 'autolemetry-cloudflare/actors';

/**
 * Cloudflare Agents SDK example with autolemetry-cloudflare instrumentation
 *
 * This example demonstrates how to use the Cloudflare Agents SDK with autolemetry-cloudflare
